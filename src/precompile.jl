function _precompile_()
    ...
    @assert precompile(Tuple{mbody.sig.parameters[1], Symbol, Bool, Bool, Bool, Iterators.Pairs{Union{},Union{},Tuple{},NamedTuple{(),Tuple{}}}, typeof(methods_by_execution!), Any, MI, DocExprs, Module, Expr})
    @assert precompile(Tuple{mbody.sig.parameters[1], Symbol, Bool, Bool, Bool, Iterators.Pairs{Symbol,Bool,Tuple{Symbol},NamedTuple{(:skip_include,),Tuple{Bool}}}, typeof(methods_by_execution!), Any, MI, DocExprs, Module, Expr})
