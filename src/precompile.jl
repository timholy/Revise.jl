...
function _precompile_()
    ...
    @warnpcfail precompile(Tuple{typeof(revise_file_queued), RevisePkgData, String})
    @warnpcfail precompile(Tuple{typeof(init_watching), RevisePkgData, Vector{String}})
    ...
    @warnpcfail precompile(Tuple{typeof(setindex!), Dict{PkgId,RevisePkgData}, RevisePkgData, PkgId})
    ...
    @warnpcfail precompile(Tuple{Type{ReviseFileInfo}, Module, String})
    @warnpcfail precompile(Tuple{Type{RevisePkgData}, PkgId})
    ...
    @warnpcfail precompile(Tuple{Core.kwftype(typeof(maybe_add_includes_to_pkgdata!)),NamedTuple{(:eval_now,), Tuple{Bool}},typeof(maybe_add_includes_to_pkgdata!),RevisePkgData,String,Vector{Pair{Module, String}}})
