...
"""
function get_def(method::Method; modified_files=revision_queue, shouldwarn::Bool=true)
    ...
    shouldwarn && @warn "$(method.sig) was not found, perhaps it was generated by code"
    return nothing
end
