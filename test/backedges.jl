...
do_test("Backedges") && @testset "Backedges" begin
    ...
    isrequired = ReviseCore.minimal_evaluation!(frame, :sigs)[1]
    ...
    """
    mexs = ReviseCore.parse_source!(Revise.ModuleExprsSigs(BackEdgesTest), src, "backedges_test.jl", BackEdgesTest)
